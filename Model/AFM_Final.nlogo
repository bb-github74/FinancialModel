patches-own
[ my-sentiment                            ;; Each trader can have a positive sentiment (+1), in which case he is 'bullish',
...
to agent-decision
  ask patches
  [
    ifelse ((propensity-to-sentiment-contagion * sum [ my-sentiment ] of neighbors4 + news-sensitivity * news-qualitative-meaning + random-normal miu opinion-vol) > 0)
    [
      set my-sentiment 1
    ...
    ; Set number-of-shares to zero if the agent does not have any shares
...
793
113
(Below) plots concerning \nMarket behavior and deviations \nto efficiency market hypothesis (EMH)
12
0.0
1
...
"" ""
PENS
"volatility" 1.0 0 -10141563 true "" ""
